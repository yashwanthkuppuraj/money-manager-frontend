...
import { UserPlus, User, Mail, Lock, Wallet } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#FAF3E1] p-4">
            <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-[#F5E7C6]">
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-[#222222]">Create Account</h1>
                    <p className="text-[#222222]/60">Join Money Manager today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        ...
                        <div className="relative">
                            <User className="absolute left-3 top-3 text-[#222222]/40" size={20} />
                            <input
                                type="text"
                                name="name"
                                required
                ...
                <p className="mt-8 text-center text-sm text-[#222222]/60">
                    ...
                    <Link to="/login" className="text-[#FA8112] font-bold hover:underline">
                        Login
                    </Link>
                </p>
            </div>
